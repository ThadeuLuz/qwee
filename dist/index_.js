...
var Motor_1 = __importDefault(require("./devices/Motor"));
// import Piezo from "./devices/Piezo";
// import { melodies } from "./helpers/emotion";
...
qwee.on("ready", function () { return __awaiter(_this, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                // Initialize board
                state_1.setState({ message: "Connecting Joystick..." });
                return [4 /*yield*/, Joystick_1["default"]()];
            case 1:
                _a.sent();
                // const piezo = Piezo();
                // piezo.play(melodies.startup);
                state_1.setState({ message: "Inicializado!" });
                motorTop = Motor_1["default"]().motorTop;
                // React to changes
                state_1.subscribe(function (state, oldState) {
                    var _a = state_1.getHelpers(state, oldState), hasChanged = _a.hasChanged, changedTo = _a.changedTo;
                    if (changedTo("joystick_x", true)) {
                        console.log("x pressed");
                    }
                    if (hasChanged("joystick_r2")) {
                        // @ts-ignore
                        var _b = motorTop.pwmRange || motorTop.range, tmin = _b[0], tmax = _b[1];
                        var throttle = misc_1.scale(state.joystick_r2, 10, 255, tmin, tmax);
